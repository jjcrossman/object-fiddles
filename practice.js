...
var favoriteThings = {
  ...
  , holiday: "National Don't Go to Work Day"
}
...
//Create an 'alsoMe' object with the following properties
...
//Create an Object called 'album' with 5 keys named different song titles
//that you make up, with the values being the length of each song.

  //Code Here
var album = {
  marioGoesToWashington: 180
  , luigiEatsACanoli: 210
  , yoshiIsFilledWithEnnui: 300
  , bowserDoesntCare: 220
  , donkeyKongGetsHisMan: 180
}
...
var mike = new makePerson ( "Mike", "September 10, 1970", "123-45-6789" );
...
// Create a function called makeCard which takes in
//cardNumber, expirationDate, and securityCode to make a Credit Card object and
...
var cardMike = new makeCard ( 9834923, "February 2020", 704 );

console.log( cardMike );
...
/* As of this point you should have a makePerson and a makeCard function which returns you either a person or a credit card object.
   ...
   Have bindCard merge the two parameters together into a new object which contains all the properties from the person as well as
   the creditcard. While Object.assign would give you the answer, specRunner requires an answer without using it.
*/
...
console.log( bindCard ( mike, cardMike ) );
